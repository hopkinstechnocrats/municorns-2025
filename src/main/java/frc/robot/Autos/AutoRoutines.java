...
public class AutoRoutines {
    ...
    public Command rotateClockwise45        = DriveCommands.drive(driveSubsystem, .05, -.05).withTimeout(1);
    public Command rotateCounterclockwise45 = DriveCommands.drive(driveSubsystem, -.05, .05).withTimeout(1);
